...
<body>
  ...
  <div class="container">
    <div class="form-wrapper">
      ...
      ?>
      <form action="../includes/staff/staffLoginController.php" method="POST">
        <div class="form-group">
          <label for="user_name" class="form-label">Username</label>
          <input type="text" class="form-control" id="user_name" name="staff_username" placeholder="Enter your username" required autofocus>
        </div>
        <div class="form-group mt-6">
          <label for="user_pass" class="form-label">Password</label>
          <input type="password" class="form-control" id="user_pass" name="staff_password" placeholder="Enter your password" required>
        </div>
        <div class="mt-3">
